...
public abstract class AbsRuntimePermission extends Activity {
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if( (grantResults.length > 0) && PackageManager.PERMISSION_GRANTED == permissionCheck) {
            ...
            Snackbar.make(findViewById(android.R.id.content),  "You can not use the functions of app", Snackbar.LENGTH_INDEFINITE).setAction("CONTINUE", new View.OnClickListener() {
                @Override
            ...
            AbsRuntimePermission.this.finish();
